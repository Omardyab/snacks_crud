...
class snackTests(TestCase):
    def setUp(self):
        self.user = get_user_model().objects.create_user(
            username="Omar", email="omar@gmail.com", password="1234"
        )
    ...
    def test_snack_content(self):
        ...
        self.assertEqual(f"{self.snack.purchaser}", "Omar")
    ...
    def test_snack_detail_view(self):
        ...
        self.assertContains(response, "purchaser: Omar")
    ...
    def test_snack_update_view_redirect(self):
        response = self.client.post(
            ...
            {"title": "JUICE","description":"APPLE","purchaser":self.user.id}
        )
